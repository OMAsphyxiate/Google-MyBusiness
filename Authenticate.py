...
client_id = r'697833433089-g2kk8gir32of7f0brvrdi6ekpkqkubau.apps.googleusercontent.com' #Google MB API client ID
client_secret = r'MymK8Pxuy6pog_fij0Rb6dji' #Google MB secrete
...
r = oauth.get('https://mybusiness.googleapis.com/v3/accounts/107604422420814997819/locations') #Submit get request using token just fetched
print(r.text)
